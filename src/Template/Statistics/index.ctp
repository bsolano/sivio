<div class="externalReferences form large-5 medium-8 columns content">
    ...
    <fieldset>
           ...
           echo $this->Form->input('ocupacion',['empty' => true,'label' => 'Ocupación' ]);
            ...
            echo $this->Form->select('estado_civil', $options,['empty' => 'Estado Civil']);
            ...
            echo $this->Form->select('escolaridad', $options,['empty' => 'Escolaridad']);
            
            $options = ['10' => '0-10', '20' => '11-20', '30' => '21-30'];
            echo $this->Form->select('edad', $options,['empty' => 'Edad']);
