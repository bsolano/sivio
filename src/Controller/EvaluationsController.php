...
class EvaluationsController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['People', 'Users', 'Advocacies']
        ];
    ...
    public function add()
    {
        ...
        $people = $this->Evaluations->People->find('list', ['limit' => 200]);
        $users = $this->Evaluations->Users->find('list', ['limit' => 200]);
        $advocacies = $this->Evaluations->Advocacies->find('list', ['limit' => 200]);
        $this->set(compact('evaluation', 'people', 'users', 'advocacies'));
        $this->set('_serialize', ['evaluation']);
    }
