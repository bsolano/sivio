...
/**
 * InternalReferencesFixture
 *
 */
class InternalReferencesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'persona_coordina' => ['type' => 'string', 'length' => 30, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'se_deniega_acceso' => ['type' => 'string', 'length' => 30, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'estado' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'consultation_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
    ...
    public $records = [
        [
            ...
            'location_id' => 1,
            'persona_coordina' => 'Lorem ipsum dolor sit amet',
            'se_deniega_acceso' => 'Lorem ipsum dolor sit amet',
            'estado' => 1,
            'consultation_id' => 1
        ],
    ];
